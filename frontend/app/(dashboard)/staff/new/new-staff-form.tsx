...
const steps = [
  ...
  },
  {
    ...
    title: "Employment",
    icon: Briefcase,
    fields: ["staff_type", "employment_type", "job_title", "department", "employment_date", "ges_staff_id", "tin_number", "nationality", "marital_status", "ghana_card_number", "ssnit_number", "teacher_license_number"],
  },
  {
    id: 4,
    title: "Banking",
              ...
              >
                ...
                {currentStep === 3 && (
                  <div className="space-y-6">
                    ...
                    {/* Employment Type and Job Title row 2 */}
                    <div className="grid gap-4 sm:grid-cols-2">
                      <FormField
                        control={form.control}
