...
import type { Class, StudentWithGuardians } from "@/types";
...
const studentFormSchema = z.object({
  ...
  status: z.enum(["active", "inactive", "graduated", "transferred", "withdrawn", "suspended"]),
...
const steps = [
  {
    ...
    title: "Personal",
    icon: User,
    fields: ["student_id", "first_name", "last_name", "date_of_birth", "gender", "status"],
  },
  {
    id: 2,
    title: "Contact",
...
export function EditStudentForm({ student, classes, initialStep = 1 }: EditStudentFormProps) {
  ...
  const handleSubmit = async () => {
    ...
    // Exclude student_id from update
    const { student_id, ...updateFields } = data;
    ...
    const result = await updateStudent(student.id, cleanData);
          ...
          <div className="flex-1 min-w-0">
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Medical information and ID numbers
                  </p>
                </div>
                ...
                <div className="rounded-lg border p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      ...
                      <Badge variant={formValues.status === "active" ? "default" : "secondary"}>
            ...
            <div className="flex justify-between pt-6 border-t">
              <Button
                type="button"
                variant="outline"
                onClick={currentStep === 1 ? () => router.push(`/students/${student.id}`) : handleBack}
