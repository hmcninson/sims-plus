    ...
    <main className="flex min-h-screen items-center justify-center bg-muted p-4">
      <div className="w-full max-w-lg">
        ...
        <div className="mb-8 rounded-lg border bg-card p-6">
          <h3 className="mb-4 font-semibold text-foreground">What&apos;s next?</h3>
          <ol className="space-y-3 text-sm text-muted-foreground">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                Login at{" "}
                <code className="rounded bg-muted px-1">{subdomain}.simsplus.io</code>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary text-xs font-medium text-primary-foreground">
        ...
        <div className="mb-6 rounded-lg bg-green-50 p-4 text-center text-sm text-green-800">
          Your <strong>14-day free trial</strong> has started. No credit card
          required.
        </div>
