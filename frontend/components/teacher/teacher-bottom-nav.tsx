...
/**
 * SIMS Plus - Teacher Portal Bottom Navigation
 *
 * Mobile-only bottom tab bar for quick navigation in the teacher portal.
...
import { Home, BookOpen, ClipboardCheck, PenLine, User } from "lucide-react";
...
const tabs: NavTab[] = [
  ...
  { label: "Attend.", href: "/teacher/attendance", icon: ClipboardCheck },
  { label: "Grading", href: "/teacher/grading", icon: PenLine },
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              ...
              href={tab.href}
              className={cn(
                "relative flex flex-1 flex-col items-center justify-center gap-0.5 py-1 text-muted-foreground transition-colors",
